...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderStyle, ssrRenderVNode, ssrRenderAttr } from "vue/server-renderer";
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-1a566efa>`);
  if ($options.pageTitle) {
    _push(`<div class="section-title-bar" data-v-1a566efa><span class="current-title" data-v-1a566efa>${ssrInterpolate($options.pageTitle)}</span></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div class="navbar-container" data-v-1a566efa><div id="nav-links" class="nav-links" data-v-1a566efa>`);
  _push(ssrRenderComponent(_component_router_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="nav-icon" data-v-1a566efa${_scopeId}><i class="fas fa-user" aria-hidden="true" data-v-1a566efa${_scopeId}></i></div><span class="sr-only" data-v-1a566efa${_scopeId}>About Me</span>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_router_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="nav-icon" data-v-1a566efa${_scopeId}><i class="fas fa-flask" aria-hidden="true" data-v-1a566efa${_scopeId}></i></div><span class="sr-only" data-v-1a566efa${_scopeId}>Research</span>`);
      } else {
        return [
          createVNode("div", { class: "nav-icon" }, [
            createVNode("i", {
  ...
  _push(ssrRenderComponent(_component_router_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="nav-icon" data-v-1a566efa${_scopeId}><i class="fas fa-microphone" aria-hidden="true" data-v-1a566efa${_scopeId}></i></div><span class="sr-only" data-v-1a566efa${_scopeId}>Talks</span>`);
      } else {
        return [
          createVNode("div", { class: "nav-icon" }, [
            createVNode("i", {
  ...
  _push(ssrRenderComponent(_component_router_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="home-icon-container" data-v-1a566efa${_scopeId}><i class="fas fa-home" aria-hidden="true" data-v-1a566efa${_scopeId}></i></div><span class="sr-only" data-v-1a566efa${_scopeId}>Home</span>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_router_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="nav-icon" data-v-1a566efa${_scopeId}><i class="fas fa-feather-alt" aria-hidden="true" data-v-1a566efa${_scopeId}></i></div><span class="sr-only" data-v-1a566efa${_scopeId}>Poetry</span>`);
      } else {
        return [
          createVNode("div", { class: "nav-icon" }, [
            createVNode("i", {
  ...
  _push(ssrRenderComponent(_component_router_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="nav-icon" data-v-1a566efa${_scopeId}><i class="fas fa-pen-nib" aria-hidden="true" data-v-1a566efa${_scopeId}></i></div><span class="sr-only" data-v-1a566efa${_scopeId}>Blogs</span>`);
      } else {
        return [
          createVNode("div", { class: "nav-icon" }, [
            createVNode("i", {
  ...
  _push(ssrRenderComponent(_component_router_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="nav-icon" data-v-1a566efa${_scopeId}><i class="fas fa-heart" aria-hidden="true" data-v-1a566efa${_scopeId}></i></div><span class="sr-only" data-v-1a566efa${_scopeId}>Life</span>`);
      } else {
        return [
          createVNode("div", { class: "nav-icon" }, [
            createVNode("i", {
  ...
  _push(`</div></div><div class="scroll-progress" style="${ssrRenderStyle({ width: $data.scrollProgress + "%" })}" data-v-1a566efa></div></nav>`);
}
...
const MainNavbar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-1a566efa"]]);
const _sfc_main$3 = {
  name: "App",
  components: {
    MainNavbar
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "home" }, _attrs))} data-v-730c231a>`);
...
const HomeView = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-730c231a"]]);
const routes = [
  {
    path: "/",
    name: "home",
  ...
  },
  {
    path: "/aboutme",
    name: "aboutme",
    component: () => import("./assets/AboutMeView-Is6cAm9p.js")
  },
  {
    path: "/research",
    name: "research",
    component: () => import("./assets/ResearchView-7OlPFfoX.js")
  },
  {
    path: "/research/:id",
    name: "ResearchDetails",
    component: () => import("./assets/ResearchDetailsView-iVIjU9uc.js"),
    props: true
  },
  {
    path: "/talks",
    name: "talks",
    component: () => import("./assets/TalksView-kiHzXfA8.js")
  },
  {
    path: "/talks/:id",
    name: "TalkDetails",
    component: () => import("./assets/TalkDetailsView-Bno6CtoX.js"),
    props: true
  },
  {
    path: "/poetry",
    name: "poetry",
    component: () => import("./assets/PoetryView-ClDlXQwm.js")
  },
  {
    path: "/poetry/:id",
    name: "PoetryDetails",
    component: () => import("./assets/PoetryDetailsView-Q9olSmOQ.js"),
    props: true
  },
  {
    path: "/blogs",
    name: "blogs",
    component: () => import("./assets/BlogsView-DNaH9mBX.js")
  },
  {
    path: "/blogs/:id",
    name: "BlogDetails",
    component: () => import("./assets/BlogDetailsView-paELrmes.js"),
    props: true
  },
  {
    path: "/life",
    name: "life",
    component: () => import("./assets/LifeView-YCz8zuIU.js")
  }
];
